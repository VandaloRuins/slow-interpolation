...
- **What gets released.** The objkt release content is the Renoir flowers series produced by the *offline* pipeline (Phase 3 of the roadmap). The live work is a separate output, probably destined for performance or installation contexts. Do not let live ambitions slow the release.
