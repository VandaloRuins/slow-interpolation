"""
generate_subject_test.py -- Generate test videos with custom subject prompts.
Uses the Test 2 workflow (best so far): skip KF + 64x linear RIFE + sigma=2.0 smoothing.

Usage:
    python generate_subject_test.py --subject throne
    python generate_subject_test.py --subject city
"""
...
SUBJECTS = {
    ...
    "E06": {
        "name": "E06_wardrobe",
        "prompts": [
            {"label": "A: Wardrobe amber", "prompt": "a palace dressing chamber with ermine royal robes on wooden stands, a crown on a velvet stand, tall mirrors reflecting frescoed walls, a carved armoire open showing royal garments and gold embroidery, marble floor, warm amber light from candelabra", "denoising": 0.470},
            {"label": "B: Wardrobe candlelit", "prompt": "a palace dressing chamber with ermine royal robes on wooden stands, a crown on a velvet stand, tall mirrors reflecting frescoed walls, a carved armoire open showing royal garments and gold embroidery, marble floor, warm candlelight from silver holders", "denoising": 0.475},
            {"label": "C: Wardrobe dusk", "prompt": "a palace dressing chamber with ermine royal robes on wooden stands, a crown on a velvet stand, tall mirrors reflecting frescoed walls, a carved armoire open showing royal garments and gold embroidery, marble floor, fading dusk light from a shuttered window", "denoising": 0.480},
            {"label": "A (return)", "prompt": "a palace dressing chamber with ermine royal robes on wooden stands, a crown on a velvet stand, tall mirrors reflecting frescoed walls, a carved armoire open showing royal garments and gold embroidery, marble floor, warm amber light from candelabra", "denoising": 0.470},
        ],
    },
    "E07": {
        "name": "E07_hourglass",
        "prompts": [
            {"label": "A: Hourglass amber", "prompt": "an hourglass on a stone shelf in a palace study, most sand fallen, the narrow glass waist at centre, carved wooden bookcases and frescoed ceiling behind, warm amber light from a tall arched window, leather-bound volumes", "denoising": 0.470},
            {"label": "B: Hourglass candlelit", "prompt": "an hourglass on a stone shelf in a palace study, most sand fallen, the narrow glass waist at centre, carved wooden bookcases and frescoed ceiling behind, warm candlelight from a brass holder, leather-bound volumes", "denoising": 0.475},
            {"label": "C: Hourglass dusk", "prompt": "an hourglass on a stone shelf in a palace study, most sand fallen, the narrow glass waist at centre, carved wooden bookcases and frescoed ceiling behind, fading dusk light from a tall arched window, leather-bound volumes", "denoising": 0.480},
            {"label": "A (return)", "prompt": "an hourglass on a stone shelf in a palace study, most sand fallen, the narrow glass waist at centre, carved wooden bookcases and frescoed ceiling behind, warm amber light from a tall arched window, leather-bound volumes", "denoising": 0.470},
        ],
    },
    "E08": {
        "name": "E08_curtain",
        "prompts": [
            {"label": "A: Curtain amber", "prompt": "a heavy curtained window in a palace chamber, fabric displaced by an unseen breeze, the stone-walled room behind with tapestries and a carved fireplace, warm amber light filtering through moving cloth, frescoed ceiling above", "denoising": 0.470},
            {"label": "B: Curtain candlelit", "prompt": "a heavy curtained window in a palace chamber, fabric displaced by an unseen breeze, the stone-walled room behind with tapestries and a carved fireplace, warm candlelight on the fabric folds, frescoed ceiling above", "denoising": 0.475},
            {"label": "C: Curtain twilight", "prompt": "a heavy curtained window in a palace chamber, fabric displaced by an unseen breeze, the stone-walled room behind with tapestries and a carved fireplace, pale twilight filtering through the cloth, frescoed ceiling above", "denoising": 0.480},
            {"label": "A (return)", "prompt": "a heavy curtained window in a palace chamber, fabric displaced by an unseen breeze, the stone-walled room behind with tapestries and a carved fireplace, warm amber light filtering through moving cloth, frescoed ceiling above", "denoising": 0.470},
        ],
    },
    "E09": {
        "name": "E09_sundial",
        "prompts": [
            {"label": "A: Sundial morning", "prompt": "a sundial on a stone terrace of a palace, gnomon casting a long shadow across carved numerals, stone balustrade and palace facade behind with arched windows and climbing vines, terracotta rooftops visible beyond, warm morning light", "denoising": 0.470},
            {"label": "B: Sundial midday", "prompt": "a sundial on a stone terrace of a palace, gnomon casting a shorter shadow across carved numerals, stone balustrade and palace facade behind with arched windows and climbing vines, terracotta rooftops visible beyond, bright warm midday light", "denoising": 0.475},
            {"label": "C: Sundial afternoon", "prompt": "a sundial on a stone terrace of a palace, gnomon casting a long shadow across carved numerals, stone balustrade and palace facade behind with arched windows and climbing vines, terracotta rooftops visible beyond, warm golden afternoon light", "denoising": 0.480},
            {"label": "A (return)", "prompt": "a sundial on a stone terrace of a palace, gnomon casting a long shadow across carved numerals, stone balustrade and palace facade behind with arched windows and climbing vines, terracotta rooftops visible beyond, warm morning light", "denoising": 0.470},
        ],
    },
    "E10": {
        "name": "E10_watchtower",
        "prompts": [
            {"label": "A: Tower first light", "prompt": "a watchtower battlement at dawn, curved merlon and embrasure framing rolling countryside below, stone worn by weather, iron torch brackets on the wall, a distant river and village rooftops, warm first light on weathered stone", "denoising": 0.470},
            {"label": "B: Tower golden", "prompt": "a watchtower battlement at dawn, curved merlon and embrasure framing rolling countryside below, stone worn by weather, iron torch brackets on the wall, a distant river and village rooftops, golden light spreading across the landscape", "denoising": 0.475},
            {"label": "C: Tower pale", "prompt": "a watchtower battlement at dawn, curved merlon and embrasure framing rolling countryside below, stone worn by weather, iron torch brackets on the wall, a distant river and village rooftops, pale grey dawn light, thin morning mist", "denoising": 0.480},
            {"label": "A (return)", "prompt": "a watchtower battlement at dawn, curved merlon and embrasure framing rolling countryside below, stone worn by weather, iron torch brackets on the wall, a distant river and village rooftops, warm first light on weathered stone", "denoising": 0.470},
        ],
    },
    "E12": {
        "name": "E12_baldachin",
        "prompts": [
            {"label": "A: Canopy warm", "prompt": "a baldachin canopy seen from directly below in a vast throne room, heavy draped velvet spreading above like a sky of rich cloth, gold fringe and tassels, stone columns rising around it, frescoed vault visible at the edges, warm amber torchlight", "denoising": 0.470},
            {"label": "B: Canopy candlelit", "prompt": "a baldachin canopy seen from directly below in a vast throne room, heavy draped velvet spreading above like a sky of rich cloth, gold fringe and tassels, stone columns rising around it, frescoed vault visible at the edges, warm candlelight from below", "denoising": 0.475},
            {"label": "C: Canopy dim", "prompt": "a baldachin canopy seen from directly below in a vast throne room, heavy draped velvet spreading above like a sky of rich cloth, gold fringe and tassels, stone columns rising around it, frescoed vault visible at the edges, dim fading evening light", "denoising": 0.480},
            {"label": "A (return)", "prompt": "a baldachin canopy seen from directly below in a vast throne room, heavy draped velvet spreading above like a sky of rich cloth, gold fringe and tassels, stone columns rising around it, frescoed vault visible at the edges, warm amber torchlight", "denoising": 0.470},
        ],
    },
    "E13": {
        "name": "E13_hall",
        "prompts": [
            {"label": "A: Hall torchlit", "prompt": "a palace reception hall receding into depth, iron torches on stone walls with carved pilasters, frescoed vaulted ceiling with painted figures, marble floor reflecting amber light, tapestries between arched windows, the far end dissolving into golden haze", "denoising": 0.470},
    ...
    # --- Next 10 curated session subjects (E21-E31) ---
    "E21": {
        "name": "E21_hearth",
        "prompts": [
...
def main():
    ...
    parser.add_argument("--full", action="store_true", help="Full 3-minute video (54 steady frames) instead of test mode (12)")
    ...
    from generate_videos import (
        GEN_WIDTH, GEN_HEIGHT, LORA_SCALE, LORA_CANDIDATES,
        NUM_INFERENCE_STEPS, GUIDANCE_SCALE,
        CROPS_COORDS_TOP_LEFT, ORIGINAL_SIZE, TARGET_SIZE,
    ...
    # A1 best workflow settings
    STEADY_STRENGTHS = [0.55, 0.55, 0.60, 0.55, 0.55, 0.65, 0.55, 0.60]
    FPS = 24
    STEADY_FRAMES = 17 if args.full else 12    # full=17 -> ~3:03 at 64x/24fps
    TRANSITION_FRAMES = 6 if args.full else 3
    RETURN_FRAMES = 16 if args.full else 6
    WARMUP_FRAMES = 3

    OUTPUT_DIR = BASE_DIR / "videos" / ("sessions" if args.full else "")
    ...
    # Load pipeline (same as crown script)
    ...
    # Generate segments (same logic as crown script)
